...
else
{
	...
	else
	{
		...
		//	driver.quit();
			...
			System.setProperty("webdriver.edge.driver","D:\\SeleniumDriver\\MicrosoftWebDriver.exe");
	...
	//	driver.quit();
		...
		e.printStackTrace();
			...
			}else if(browser.equalsIgnoreCase("Opera"))
			{
				...
				//set path to Edge.exe
				System.setProperty("webdriver.opera.driver","D:\\SeleniumDriver\\operadriver.exe");
				//create Edge instance
