...
public class Read_XLS {
	...
	/*****************************************
	 * Function to Read_XLS Or Read_XLSX
	 * ************************************************** CONSTRUCTOR NAME :
	 * Read_XLS Read_XLS (String filelocation)
	 * 
	 * DESCRIPTION : This function is used to 1. Taking location of excel file.
	 * 
	 * 
	 * 
	 * 
	...
	/*****************************************
	 * Function to retrieveNoOfRows
	 * ************************************************** FUNCTION NAME :
	 * retrieveNoOfRows(String wsName)
	 * 
	 * DESCRIPTION : This function is used to 1. To retrieve No Of Rows from
	 * .xls file's sheets.
	 * 
	 * 
	 * 
	...
	/*****************************************
	 * Function to retrieveNoOfCols
	 * ************************************************** FUNCTION NAME :
	 * retrieveNoOfCols(String wsName)
	 * 
	 * DESCRIPTION : This function is used to 1.To retrieve No Of Columns from
	 * .cls file's sheets.
	 * 
	 * 
	 * 
	...
	/*****************************************
	 * Function to retrieveToRunFlag
	 * ************************************************** FUNCTION NAME :
	 * retrieveToRunFlag(String wsName, String colName, String rowName)
	 * 
	 * DESCRIPTION : This function is used to 1.To retrieve SuiteToRun and
	 * CaseToRun flag of test suite and test case.
	 * 
	 * 
	 * 
	 * 
	...
	/*****************************************
	 * Function to retrieveToRunFlagTestData
	 * ************************************************** FUNCTION NAME :
	 * retrieveToRunFlagTestData(String wsName, String colName)
	 * 
	 * DESCRIPTION : This function is used to 1.To retrieve DataToRun flag of
	 * test data.
	 * 
	 * 
	 * 
	...
	/*****************************************
	 * Function to retrieveTestData
	 * ************************************************** FUNCTION NAME :
	 * retrieveTestData(String wsName)
	 * 
	 * DESCRIPTION : This function is used to 1.To retrieve test data from test
	 * case data sheets.
	 * 
	 * 
	 * 
	...
	/*****************************************
	 * Function to writeResult
	 * ************************************************** FUNCTION NAME :
	 * writeResult(String wsName, String colName, int rowNumber, String Result)
	 * 
	 * DESCRIPTION : This function is used to 1.To write result In test data and
	 ...
	 * Function to writeResult
	 * ************************************************** FUNCTION NAME :
	 * writeResult(String wsName, String colName, String rowName, String Result)
	 * 
	 * DESCRIPTION : This function is used to 1.To write result In test suite
	 * list sheet.
	 * 
	 * 
	 * 
